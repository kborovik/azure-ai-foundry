...
T1|.|init talos Click CLI deploy+test, CPython 3.14, plan docs, unit CLI tests, GHA unit workflow|V10,I.cmd
T2|.|add talos generate local-only: facts.yaml, jinja templates, 12 MD + manifest, watermark, fact-key uniqueness|V2,V5,V28,I.cmd,I.file
